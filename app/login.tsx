...
// Certifique-se de que o caminho do seu arquivo firebase está correto
...
export default function LoginScreen() {
  ...
  const handleAuth = async () => {
    ...
    try {
      ...
      // Se deu tudo certo, joga o professor para o Painel (Dashboard)
      router.replace('/'); 
    ...
    >
      <View style={[styles.container, { padding: isMobile ? 16 : 32 }]}>
        ...
        <View style={[styles.card, { padding: isMobile ? 32 : 48 }]}>
          ...
          {/* Logo Definitiva Salva na Memória */}
...
// ─────────────────────────────────────────────
// Estilos (Mantendo a Identidade Visual Escura)
// ─────────────────────────────────────────────
const styles = StyleSheet.create({
  ...
  subtitle: { color: '#8b89a0', fontSize: 14, fontWeight: '500', marginBottom: 32, textAlign: 'center' },
